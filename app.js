...
Opal.modules["components/remained_time"] = function(Opal) {
  ...
  return (function($base, $parent_nesting) {
    ...
    (function($base, $super, $parent_nesting) {
      ...
      var self = $RemainedTime = $klass($base, $super, 'RemainedTime', $RemainedTime);

      var def = self.$$proto, $nesting = [self].concat($parent_nesting), TMP_RemainedTime_render_2;

      return (Opal.defn(self, '$render', TMP_RemainedTime_render_2 = function $$render($kwargs) {
        var TMP_1, self = this, remain_seconds, abs_remain_seconds = nil, minutes = nil, seconds = nil, classes = nil;
        ...
        return $send(self, 'o', ["div"], (TMP_1 = function(){var self = TMP_1.$$s || this;
          ...
          return self.$o("span", $hash2(["class"], {"class": "label"}), "sec");}, TMP_1.$$s = self, TMP_1.$$arity = 0, TMP_1));
      }, TMP_RemainedTime_render_2.$$arity = 1), nil) && 'render'
...
(function(Opal) {
  ...
  var self = Opal.top, $nesting = [], nil = Opal.nil, $breaker = Opal.breaker, $slice = Opal.slice, $klass = Opal.klass, $gvars = Opal.gvars, $truthy = Opal.truthy, $send = Opal.send, $hash2 = Opal.hash2;

  Opal.add_stubs(['$require', '$match', '$hash', '$location', '$map', '$captures', '$to_proc', '$+', '$*', '$lambda', '$update_now', '$actions', '$requestAnimationFrame', '$call', '$item', '$now', '$start_time', '$presentation_time', '$-', '$end_time', '$o', '$negative?', '$remain_seconds', '$state', '$run']);
  ...
  (function($base, $super, $parent_nesting) {
    ...
    var def = self.$$proto, $nesting = [self].concat($parent_nesting), TMP_MyApp_presentation_time_1, TMP_MyApp_setup_3;

    
    Opal.defs(self, '$presentation_time', TMP_MyApp_presentation_time_1 = function $$presentation_time() {
    ...
    }, TMP_MyApp_presentation_time_1.$$arity = 0);
    
    Opal.defn(self, '$setup', TMP_MyApp_setup_3 = function $$setup() {
      var TMP_2, self = this, loop = nil;

      
      loop = $send(self, 'lambda', [], (TMP_2 = function(){var self = TMP_2.$$s || this;
        if ($gvars.$ == null) $gvars.$ = nil;

      
        self.$actions().$update_now();
        return $gvars.$.$requestAnimationFrame(loop);}, TMP_2.$$s = self, TMP_2.$$arity = 0, TMP_2));
      return loop.$call();
    }, TMP_MyApp_setup_3.$$arity = 0);
    (function($base, $super, $parent_nesting) {
      function $State(){};
      var self = $State = $klass($base, $super, 'State', $State);

      var def = self.$$proto, $nesting = [self].concat($parent_nesting), TMP_State_end_time_4, TMP_State_remain_seconds_5;

      
      self.$item("start_time", $hash2(["default"], {"default": Opal.const_get_relative($nesting, 'Time').$now()}));
      self.$item("now", $hash2(["default"], {"default": Opal.const_get_relative($nesting, 'Time').$now()}));
      
      Opal.defn(self, '$end_time', TMP_State_end_time_4 = function $$end_time() {
        var self = this;

        return $rb_plus(self.$start_time(), Opal.const_get_relative($nesting, 'MyApp').$presentation_time())
      }, TMP_State_end_time_4.$$arity = 0);
      return (Opal.defn(self, '$remain_seconds', TMP_State_remain_seconds_5 = function $$remain_seconds() {
        var self = this;

        return $rb_minus(self.$end_time(), self.$now())
      }, TMP_State_remain_seconds_5.$$arity = 0), nil) && 'remain_seconds';
    })($nesting[0], Opal.const_get_qualified(Opal.const_get_relative($nesting, 'Ovto'), 'State'), $nesting);
    (function($base, $super, $parent_nesting) {
      function $Actions(){};
      var self = $Actions = $klass($base, $super, 'Actions', $Actions);

      var def = self.$$proto, $nesting = [self].concat($parent_nesting), TMP_Actions_update_now_6;

      return (Opal.defn(self, '$update_now', TMP_Actions_update_now_6 = function $$update_now() {
        var self = this;

        return $hash2(["now"], {"now": Opal.const_get_relative($nesting, 'Time').$now()})
      }, TMP_Actions_update_now_6.$$arity = 0), nil) && 'update_now'
    ...
    return (function($base, $super, $parent_nesting) {
      ...
      var def = self.$$proto, $nesting = [self].concat($parent_nesting), TMP_MainComponent_render_11;

      return (Opal.defn(self, '$render', TMP_MainComponent_render_11 = function $$render() {
        var TMP_7, self = this;

        return $send(self, 'o', ["div", $hash2(["class"], {"class": "timer"})], (TMP_7 = function(){var self = TMP_7.$$s || this, TMP_8, TMP_10;
          ...
          $send(self, 'o', ["div", $hash2(["class"], {"class": "" + "text-container " + ((function() {if ($truthy(self.$state().$remain_seconds()['$negative?']())) {
            ...
            return nil
          }; return nil; })())})], (TMP_8 = function(){var self = TMP_8.$$s || this, TMP_9;

          return $send(self, 'o', ["div", $hash2(["class"], {"class": "text-subcontainer"})], (TMP_9 = function(){var self = TMP_9.$$s || this;

            return self.$o(Opal.const_get_qualified(Opal.const_get_relative($nesting, 'Components'), 'RemainedTime'), $hash2(["remain_seconds"], {"remain_seconds": self.$state().$remain_seconds()}))}, TMP_9.$$s = self, TMP_9.$$arity = 0, TMP_9))}, TMP_8.$$s = self, TMP_8.$$arity = 0, TMP_8));
          return $send(self, 'o', ["div", $hash2(["class"], {"class": "progress-container"})], (TMP_10 = function(){var self = TMP_10.$$s || this;

          return self.$o("progress", $hash2(["max", "value"], {"max": Opal.const_get_relative($nesting, 'MyApp').$presentation_time(), "value": self.$state().$remain_seconds()}))}, TMP_10.$$s = self, TMP_10.$$arity = 0, TMP_10));}, TMP_7.$$s = self, TMP_7.$$arity = 0, TMP_7))
      }, TMP_MainComponent_render_11.$$arity = 0), nil) && 'render'
    })($nesting[0], Opal.const_get_qualified(Opal.const_get_relative($nesting, 'Ovto'), 'Component'), $nesting);
