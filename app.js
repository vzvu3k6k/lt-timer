...
(function(Opal) {
  ...
  Opal.add_stubs(['$require', '$match', '$hash', '$location', '$map', '$captures', '$to_proc', '$+', '$*', '$lambda', '$update_now', '$actions', '$requestAnimationFrame', '$call', '$item', '$now', '$start_time', '$presentation_time', '$-', '$end_time', '$negative?', '$remain_seconds', '$o', '$over?', '$state', '$abs', '$floor', '$/', '$%', '$positive?', '$[]', '$run']);
  ...
  (function($base, $super, $parent_nesting) {
    ...
    (function($base, $super, $parent_nesting) {
      ...
      var def = self.$$proto, $nesting = [self].concat($parent_nesting), TMP_State_end_time_4, TMP_State_remain_seconds_5, TMP_State_over$q_6;
      ...
      Opal.defn(self, '$remain_seconds', TMP_State_remain_seconds_5 = function $$remain_seconds() {
        var self = this;

        return $rb_minus(self.$end_time(), self.$now())
      }, TMP_State_remain_seconds_5.$$arity = 0);
      return (Opal.defn(self, '$over?', TMP_State_over$q_6 = function() {
        var self = this;

        return self.$remain_seconds()['$negative?']()
      }, TMP_State_over$q_6.$$arity = 0), nil) && 'over?';
    })($nesting[0], Opal.const_get_qualified(Opal.const_get_relative($nesting, 'Ovto'), 'State'), $nesting);
    (function($base, $super, $parent_nesting) {
      function $Actions(){};
      var self = $Actions = $klass($base, $super, 'Actions', $Actions);

      var def = self.$$proto, $nesting = [self].concat($parent_nesting), TMP_Actions_update_now_7;

      return (Opal.defn(self, '$update_now', TMP_Actions_update_now_7 = function $$update_now() {
        var self = this;

        return $hash2(["now"], {"now": Opal.const_get_relative($nesting, 'Time').$now()})
      }, TMP_Actions_update_now_7.$$arity = 0), nil) && 'update_now'
    ...
    return (function($base, $super, $parent_nesting) {
      ...
      var def = self.$$proto, $nesting = [self].concat($parent_nesting), TMP_MainComponent_render_12;

      return (Opal.defn(self, '$render', TMP_MainComponent_render_12 = function $$render() {
        var TMP_8, self = this;

        return $send(self, 'o', ["div", $hash2(["class"], {"class": "timer"})], (TMP_8 = function(){var self = TMP_8.$$s || this, TMP_9, TMP_11;

        
          $send(self, 'o', ["div", $hash2(["class"], {"class": "" + "text-container " + ((function() {if ($truthy(self.$state()['$over?']())) {
            return "over"
            } else {
            return nil
          }; return nil; })())})], (TMP_9 = function(){var self = TMP_9.$$s || this, TMP_10;

          return $send(self, 'o', ["div", $hash2(["class"], {"class": "text-subcontainer"})], (TMP_10 = function(){var self = TMP_10.$$s || this, abs_remain_seconds = nil, minutes = nil, seconds = nil, classes = nil;

            
              abs_remain_seconds = self.$state().$remain_seconds().$abs();
              ...
              return self.$o("span", $hash2(["class"], {"class": "label"}), "sec");}, TMP_10.$$s = self, TMP_10.$$arity = 0, TMP_10))}, TMP_9.$$s = self, TMP_9.$$arity = 0, TMP_9));
          return $send(self, 'o', ["div", $hash2(["class"], {"class": "progress-container"})], (TMP_11 = function(){var self = TMP_11.$$s || this;

          return self.$o("progress", $hash2(["max", "value"], {"max": Opal.const_get_relative($nesting, 'MyApp').$presentation_time(), "value": self.$state().$remain_seconds()}))}, TMP_11.$$s = self, TMP_11.$$arity = 0, TMP_11));}, TMP_8.$$s = self, TMP_8.$$arity = 0, TMP_8))
      }, TMP_MainComponent_render_12.$$arity = 0), nil) && 'render'
