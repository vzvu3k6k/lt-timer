...
(function(Opal) {
  ...
  var self = Opal.top, $nesting = [], nil = Opal.nil, $breaker = Opal.breaker, $slice = Opal.slice, $klass = Opal.klass, $hash2 = Opal.hash2, $gvars = Opal.gvars, $send = Opal.send, $truthy = Opal.truthy;

  Opal.add_stubs(['$require', '$*', '$set_timer', '$actions', '$item', '$now', '$+', '$start_time', '$max', '$-', '$end_time', '$requestAnimationFrame', '$lambda', '$o', '$floor', '$/', '$remain_seconds', '$state', '$%', '$positive?', '$[]', '$run']);
  ...
  (function($base, $super, $parent_nesting) {
    ...
    var def = self.$$proto, $nesting = [self].concat($parent_nesting), TMP_MyApp_setup_1;

    
    Opal.const_set($nesting[0], 'PRESENTATION_TIME', $rb_times(60, 5));
    
    Opal.defn(self, '$setup', TMP_MyApp_setup_1 = function $$setup() {
      var self = this;

      return self.$actions().$set_timer()
    }, TMP_MyApp_setup_1.$$arity = 0);
    (function($base, $super, $parent_nesting) {
      function $State(){};
      var self = $State = $klass($base, $super, 'State', $State);

      var def = self.$$proto, $nesting = [self].concat($parent_nesting), TMP_State_end_time_2, TMP_State_remain_seconds_3;
      ...
      Opal.defn(self, '$end_time', TMP_State_end_time_2 = function $$end_time() {
        var self = this;

        return $rb_plus(self.$start_time(), Opal.const_get_relative($nesting, 'PRESENTATION_TIME'))
      }, TMP_State_end_time_2.$$arity = 0);
      return (Opal.defn(self, '$remain_seconds', TMP_State_remain_seconds_3 = function $$remain_seconds() {
        var self = this;

        return [$rb_minus(self.$end_time(), self.$now()), 0].$max()
      }, TMP_State_remain_seconds_3.$$arity = 0), nil) && 'remain_seconds';
    })($nesting[0], Opal.const_get_qualified(Opal.const_get_relative($nesting, 'Ovto'), 'State'), $nesting);
    (function($base, $super, $parent_nesting) {
      function $Actions(){};
      var self = $Actions = $klass($base, $super, 'Actions', $Actions);

      var def = self.$$proto, $nesting = [self].concat($parent_nesting), TMP_Actions_set_timer_5;

      return (Opal.defn(self, '$set_timer', TMP_Actions_set_timer_5 = function $$set_timer() {
        var TMP_4, self = this;
        if ($gvars.$ == null) $gvars.$ = nil;

        
        $gvars.$.$requestAnimationFrame($send(self, 'lambda', [], (TMP_4 = function(){var self = TMP_4.$$s || this;

        return self.$actions().$set_timer()}, TMP_4.$$s = self, TMP_4.$$arity = 0, TMP_4)));
        return $hash2(["now"], {"now": Opal.const_get_relative($nesting, 'Time').$now()});
      }, TMP_Actions_set_timer_5.$$arity = 0), nil) && 'set_timer'
    ...
    return (function($base, $super, $parent_nesting) {
      ...
      return (Opal.defn(self, '$render', TMP_MainComponent_render_7 = function $$render() {
        var TMP_6, self = this;

        return $send(self, 'o', ["div", $hash2(["class"], {"class": "timer"})], (TMP_6 = function(){var self = TMP_6.$$s || this, minutes = nil, seconds = nil, classes = nil;

        
          minutes = $rb_divide(self.$state().$remain_seconds(), 60).$floor();
          seconds = self.$state().$remain_seconds()['$%'](60).$floor();
          ...
          self.$o("span", $hash2(["class"], {"class": "label"}), "sec");
          return self.$o("progress", $hash2(["max", "value"], {"max": Opal.const_get_relative($nesting, 'PRESENTATION_TIME'), "value": self.$state().$remain_seconds()}));}, TMP_6.$$s = self, TMP_6.$$arity = 0, TMP_6))
      }, TMP_MainComponent_render_7.$$arity = 0), nil) && 'render'
